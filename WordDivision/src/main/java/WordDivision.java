...
public class WordDivision {
    public static void main(String[] args)
    {
        ...
        MongoCollection<Document> collection1 = dao.getCollection("mytest2","nperson2");
...
//                    }
            ...
            Document document1 = new Document("_id",curdata.get("_id")).
                    append("user",curdata.get("user")).append("keyword",kwords).append("topic",topics).append("comment",comments);
